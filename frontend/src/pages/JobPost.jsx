  ...
  console.log(hirerId);
    ...
    const [formData, setFormData] = useState({
      ...
      return (
        <>
                  <Navbar/>
        <div className="bg-black py-8 w-screen h-screen content-center">
        <div className="w-3/5 mx-auto p-6 bg-gray-900 rounded-lg border-2 border-gray-400 pt-16 mt-20">
